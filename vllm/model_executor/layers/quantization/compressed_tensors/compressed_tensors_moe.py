...
class CompressedTensorsW4A4Nvfp4MoEMethod(CompressedTensorsMoEMethod):
    ...
    def process_weights_after_loading(self, layer: FusedMoE) -> None:
        ...
        if (torch.cuda.is_available()
            ...
            w13_scale_2 = w13_scale_2.clone() if isinstance(w13_scale_2, torch.Tensor) else w13_scale_2
            w2 = w2.clone()
            w2_scale = w2_scale.clone()
            w2_scale_2 = w2_scale_2.clone() if isinstance(w2_scale_2, torch.Tensor) else w2_scale_2
